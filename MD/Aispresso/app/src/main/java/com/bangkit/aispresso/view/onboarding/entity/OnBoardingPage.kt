package com.bangkit.aispresso.view.onboarding.entity
...
enum class OnBoardingPage(
    ...
    THREE(R.string.onboarding_slide3_title, R.string.onboarding_slide3_subtitle,R.string.onboarding_slide3_desc, R.drawable.onboarding_tiga)
